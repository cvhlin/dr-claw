...
function CredentialsSettings() {
  ...
  // Version check hook
  const { updateAvailable, latestVersion, releaseInfo } = useVersionCheck('bbsngg', 'VibeLab-beta');
    ...
    <div className="space-y-8">
      ...
      <div className="pt-6 border-t border-border/50">
        <div className="flex items-center justify-between text-xs italic text-muted-foreground/60">
          <a
            href={releaseInfo?.htmlUrl || 'https://github.com/bbsngg/VibeLab-beta/releases'}
            target="_blank"
            rel="noopener noreferrer"
