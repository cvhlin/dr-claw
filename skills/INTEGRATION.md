...
- **Request body** (example):
  ...
  - Optional: `category`, `max_iter_times`, `instance` (path to instance file; paths inside instance.json are typically **absolute** when created by Vibe Lab, or may be relative; consumers should use as-is when absolute).
